...
public class AgendaEventos {
    ...
    public void obterProximoEvento() {
        ...
        llection<Evento> values = eventosMap.values();
        eventosMap.get();*/

        LocalDate dataAutal = LocalDate.now();
        Map<LocalDate, Evento> eventosTreeMap = new TreeMap<>(eventosMap);
        for (Map.Entry<LocalDate, Evento> entry : eventosTreeMap.entrySet()) {
            if (entry.getKey().isEqual(dataAutal) || entry.getKey().isAfter(dataAutal)) {
    ...
    public static void main(String[] args) {
        ...
        agendaEventos.adicionarEvento(LocalDate.of(2025, 9, 10), "Evento 4", "Atração 4");
